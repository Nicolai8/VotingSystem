...
--Create themes
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user11,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'1Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.1',2,'Voting 1')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user3,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'2Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.2',4,'Voting 2')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user11,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'3Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.3',2,'Voting 3')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user8,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'4Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.4',3,'Voting 4')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user10,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'5Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.5',4,'Voting 5')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user1,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'6Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.6',3,'Voting 6')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user1,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'7Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.7',2,'Voting 7')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user12,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'8Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.8',2,'Voting 8')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user6,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'9Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.9',2,'Voting 9')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user2,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'10Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.10',3,'Voting 10')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user9,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'11Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.11',2,'Voting 11')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user10,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'12Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.12',4,'Voting 12')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user8,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'13Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.13',1,'Voting 13')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user5,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'14Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.14',3,'Voting 14')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user11,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'15Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.15',2,'Voting 15')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user7,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'16Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.16',1,'Voting 16')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user2,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'17Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.17',1,'Voting 17')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user1,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'18Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.18',3,'Voting 18')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user4,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'19Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.19',3,'Voting 19')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user4,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'20Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.20',2,'Voting 20')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user6,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'21Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.21',3,'Voting 21')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user10,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'22Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.22',2,'Voting 22')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user11,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'23Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.23',2,'Voting 23')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user4,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'24Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.24',4,'Voting 24')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user5,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'25Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.25',4,'Voting 25')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user5,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'26Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.26',1,'Voting 26')
	INSERT INTO THEME([UserId],[CreateDate],[StartDate],[FinishTime],[Description],[Status],[VotingName]) VALUES(@user10,getdate(),(SELECT CONVERT(DATE, GETDATE())),DATEADD(day,7,(SELECT CONVERT(DATE, GETDATE()))),'27Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leo ut odio. Curabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.27',1,'Voting 27')
...
--Add questions
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 1',1,@voting1)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 2',1,@voting1)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 3',1,@voting1)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 4',1,@voting2)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 5',1,@voting2)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 6',1,@voting2)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 7',1,@voting27)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 8',1,@voting20)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 9',1,@voting3)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 10',1,@voting21)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 11',1,@voting4)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 12',1,@voting26)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 13',1,@voting5)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 14',1,@voting5)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 15',1,@voting22)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 16',1,@voting6)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 17',1,@voting23)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 18',1,@voting7)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 19',1,@voting8)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 20',1,@voting8)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 21',1,@voting9)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 22',1,@voting9)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 23',1,@voting10)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 24',1,@voting24)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 25',1,@voting10)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 26',2,@voting11)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 27',2,@voting25)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 28',2,@voting12)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 29',2,@voting13)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 30',2,@voting14)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 31',2,@voting15)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 32',2,@voting15)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 33',2,@voting16)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 34',2,@voting17)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 35',2,@voting17)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 36',2,@voting18)
	INSERT INTO Question([Text],[Type],[ThemeId]) VALUES('Question Text 37',1,@voting19)
