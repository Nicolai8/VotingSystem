	...
	function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
		...
		function makeSpritedButtonRow() {
			...
			var makeButton = function (id, title, icon, textOp, group) {
				...
				button.dataset.container = ".wmd-panel";
				$(button).tooltip();
				if (textOp)
...
(function (factory) {
	if (typeof define === 'function' && define.amd) {
		...
		if (!jQuery) {
			throw 'jquery.pagedown-bootstrap.combined requires jQuery to be loaded first';
		} else {
			factory(jQuery);
		}
	}
	...
	$.fn.pagedownBootstrap = function (options) {
		...
		return this.each(function () {
			...
			$(this).after('<div class="well"><div id="wmd-preview-' + idAppend + '" class="wmd-preview" /></div>');
