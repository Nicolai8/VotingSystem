angular.module("votingSystem.controllers.voting", [])
	.controller("VotingCtrl", ["$scope", "$http", "$route", "$routeParams", "$location", "urls", "constants", "Voting", "VotingStorage",
		"VoiceStorage", "CommentStorage", "commentsHub",
		function ($scope, $http, $route, $routeParams, $location, urls, constants, Voting, VotingStorage, VoiceStorage, CommentStorage, commentsHub) {
